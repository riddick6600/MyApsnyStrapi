...
var getEERoutes$1 = () => window.strapi.isEE ? [
  {
    ...
    lazy: async () => {
      const { AuthResponse } = await import("./AuthResponse-8JdghoaK-NM3LUZZT.js");
      return {
  ...
  return (0, import_jsx_runtime.jsx)(
    StrapiAppProvider,
    {
      ...
      children: (0, import_jsx_runtime.jsx)(Provider_default, {
        store, children: (0, import_jsx_runtime.jsx)(QueryClientProvider, {
          client: queryClient, children: (0, import_jsx_runtime.jsx)(AuthProvider, {
            children: (0, import_jsx_runtime.jsx)(HistoryProvider, {
              children: (0, import_jsx_runtime.jsx)(LanguageProvider, {
                messages: strapi.configurations.translations, children: (0, import_jsx_runtime.jsx)(Theme, {
                  themes: strapi.configurations.themes, children: (0, import_jsx_runtime.jsx)(NotificationsProvider, {
...
var App = ({ strapi, store }) => {
  (0, import_react10.useEffect)(() => {
    const language = localStorage.getItem(LANGUAGE_LOCAL_STORAGE_KEY) || "ru";
    if (language) {
...
\`\`\`
    ...
    return (0, import_jsx_runtime.jsx)(Main, {
      height: "100%", children: (0, import_jsx_runtime.jsx)(Flex, {
        alignItems: "center", height: "100%", justifyContent: "center", children: (0, import_jsx_runtime.jsxs)(
          Flex,
          {
            gap: 7,
            padding: 7,
            ...
            children: [
              (0, import_jsx_runtime.jsxs)(Flex, {
                direction: "column", gap: 2, children: [
                  ...
                  (0, import_jsx_runtime.jsx)(Typography, {
                    fontSize: 4, fontWeight: "bold", textAlign: "center", children: formatMessage({
                      id: "app.error",
                      defaultMessage: "Something went wrong"
                    })
                  }),
                  (0, import_jsx_runtime.jsx)(Typography, {
                    variant: "omega", textAlign: "center", children: formatMessage(
                      {
              ...
              (0, import_jsx_runtime.jsxs)(Flex, {
                gap: 4, direction: "column", width: "100%", children: [
                  ...
                  (0, import_jsx_runtime.jsx)(Button, {
                    onClick: handleClick, variant: "tertiary", startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$3L, {}), children: formatMessage({
                      id: "app.error.copy",
...
var RootLayout = ({ sideNav, children }) => {
  return (0, import_jsx_runtime.jsxs)(GridContainer, {
    $hasSideNav: Boolean(sideNav), children: [
      sideNav,
        ...
        children: (0, import_jsx_runtime.jsx)(
          EmptyStateLayout,
          {
            action: (0, import_jsx_runtime.jsx)(LinkButton, {
              tag: Link, variant: "secondary", endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$53, {}), to: "/", children: formatMessage({
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-4M1uu6wf-4SHEAHQM.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-C5wlFrDd-SS232NF6.js");
        return {
...
var Form2 = React10.forwardRef(
  ({ disabled = false, method, onSubmit, initialErrors, ...props }, ref) => {
    ...
    return (0, import_jsx_runtime.jsx)("form", {
      ref: composedRefs, method, noValidate: true, onSubmit: handleSubmit, children: (0, import_jsx_runtime.jsx)(
        FormProvider,
        {
          disabled,
          onChange: handleChange,
...
var Blocker = ({ onProceed = () => {
  ...
  if (blocker.state === "blocked") {
    ...
    return (0, import_jsx_runtime.jsx)(Dialog.Root, {
      open: true, onOpenChange: handleCancel, children: (0, import_jsx_runtime.jsxs)(Dialog.Content, {
        children: [
          ...
          (0, import_jsx_runtime.jsx)(Dialog.Body, {
            icon: (0, import_jsx_runtime.jsx)(ForwardRef$3, { width: "24px", height: "24px", fill: "danger600" }), children: formatMessage({
            ...
            children: [
              (0, import_jsx_runtime.jsx)(Dialog.Cancel, {
                children: (0, import_jsx_runtime.jsx)(Button, {
                  variant: "tertiary", children: formatMessage({
...
var BooleanInput = (0, import_react10.forwardRef)(
  ({ name, required, label, hint, labelAction, ...props }, ref) => {
    ...
    return (0, import_jsx_runtime.jsxs)(Field.Root, {
      error: field.error, name, hint, required, maxWidth: "320px", children: [
...
var CheckboxInput = (0, import_react10.forwardRef)(
  ({ name, required, label, hint, type: _type, ...props }, ref) => {
    ...
    const composedRefs = useComposedRefs(ref, fieldRef);
    return (0, import_jsx_runtime.jsxs)(Field.Root, {
      error: field.error, name, hint, required, children: [
        (0, import_jsx_runtime.jsx)(
          CheckboxImpl,
          {
          ...
          SingleSelect,
          {
            ...
            children: [
              (0, import_jsx_runtime.jsx)(SingleSelectOption, {
                value: "", disabled: required, hidden: required, children: formatMessage({
...
var NotSupportedField = (0, import_react10.forwardRef)(
  ({ label, hint, name, required, type, labelAction }, ref) => {
    ...
    const composedRefs = useComposedRefs(ref, fieldRef);
    return (0, import_jsx_runtime.jsxs)(Field.Root, {
      error, name, hint, required, children: [
        (0, import_jsx_runtime.jsx)(Field.Label, { action: labelAction, children: label }),
        (0, import_jsx_runtime.jsx)(
          TextInput,
          {
    ...
    children: (0, import_jsx_runtime.jsxs)(Main, {
      children: [
          ...
          children: [
            (0, import_jsx_runtime.jsxs)(Column, {
              children: [
                ...
                (0, import_jsx_runtime.jsx)(Box, {
                  paddingTop: 6, paddingBottom: 1, children: (0, import_jsx_runtime.jsx)(Typography, {
                    variant: "alpha", tag: "h1", children: formatMessage({
                ...
                (0, import_jsx_runtime.jsx)(Box, {
                  paddingBottom: 7, children: (0, import_jsx_runtime.jsx)(Typography, {
                    variant: "epsilon", textColor: "neutral600", children: formatMessage({
            ...
            (0, import_jsx_runtime.jsx)(
              Form2,
              {
                ...
                children: (0, import_jsx_runtime.jsxs)(Flex, {
                  direction: "column", alignItems: "stretch", gap: 6, children: [
                    [
                      {
        ...
        (0, import_jsx_runtime.jsx)(Flex, {
          justifyContent: "center", children: (0, import_jsx_runtime.jsx)(Box, {
            paddingTop: 4, children: (0, import_jsx_runtime.jsx)(Link2, {
              isExternal: false, tag: NavLink, to: "/auth/forgot-password", children: formatMessage({
          ...
          children: [
            (0, import_jsx_runtime.jsxs)(Column, {
              children: [
                (0, import_jsx_runtime.jsx)(Logo, {}),
                (0, import_jsx_runtime.jsx)(Box, {
                  paddingTop: 6, paddingBottom: 7, children: (0, import_jsx_runtime.jsx)(Typography, {
                    tag: "h1", variant: "alpha", children: formatMessage({
                ...
                error ? (0, import_jsx_runtime.jsx)(Typography, {
                  id: "global-form-error", role: "alert", tabIndex: -1, textColor: "danger600", children: isBaseQueryError(error) ? formatAPIError(error) : formatMessage({
              ...
              Form2,
              {
                ...
                children: (0, import_jsx_runtime.jsxs)(Flex, {
                  direction: "column", alignItems: "stretch", gap: 6, children: [
                    ...
                    (0, import_jsx_runtime.jsx)(Button, {
                      type: "submit", fullWidth: true, children: formatMessage({
        ...
        (0, import_jsx_runtime.jsx)(LayoutContent, {
          children: (0, import_jsx_runtime.jsxs)(Column, {
            children: [
              ...
              (0, import_jsx_runtime.jsx)(Box, {
                paddingTop: 4, children: (0, import_jsx_runtime.jsx)(Typography, {
                  children: formatMessage({
    ...
    children: (0, import_jsx_runtime.jsx)(
      Formik,
      {
        ...
        children: ({ values, handleChange, setFieldValue, isSubmitting }) => (0, import_jsx_runtime.jsx)(Form, {
          name: "npsSurveyForm", children: (0, import_jsx_runtime.jsx)(
            Flex,
            {
              hasRadius: true,
              direction: "column",
              ...
              children: isFeedbackResponse ? (0, import_jsx_runtime.jsx)(Typography, {
                fontWeight: "semiBold", children: formatMessage({
                  id: "app.components.NpsSurvey.feedback-response",
                  defaultMessage: "Thank you very much for your feedback!"
                })
              }) : (0, import_jsx_runtime.jsxs)(Box, {
                tag: "fieldset", width: "100%", borderWidth: 0, children: [
                  (0, import_jsx_runtime.jsxs)(Flex, {
                    justifyContent: "space-between", width: "100%", children: [
                      (0, import_jsx_runtime.jsx)(Box, {
                        marginLeft: "auto", marginRight: "auto", children: (0, import_jsx_runtime.jsx)(Typography, {
                          fontWeight: "semiBold", tag: "legend", children: formatMessage({
                  ...
                  (0, import_jsx_runtime.jsxs)(Flex, {
                    gap: 2, marginTop: 2, marginBottom: 2, justifyContent: "center", children: [
                      (0, import_jsx_runtime.jsx)(Typography, {
                        variant: "pi", textColor: "neutral600", children: formatMessage({
                  ...
                  values.npsSurveyRating !== null && (0, import_jsx_runtime.jsxs)(Flex, {
                    direction: "column", children: [
                      (0, import_jsx_runtime.jsx)(Box, {
                        marginTop: 2, children: (0, import_jsx_runtime.jsx)(Field.Label, {
                          fontWeight: "semiBold", fontSize: 2, children: formatMessage({
                      ...
                      (0, import_jsx_runtime.jsx)(Box, {
                        width: "62%", marginTop: 3, marginBottom: 4, children: (0, import_jsx_runtime.jsx)(
                          Textarea,
                          {
                      ...
                      (0, import_jsx_runtime.jsx)(Button, {
                        marginBottom: 2, type: "submit", loading: isSubmitting, children: formatMessage({
...
var Register = ({ hasAdmin }) => {
  ...
  return (0, import_jsx_runtime.jsx)(UnauthenticatedLayout, {
    children: (0, import_jsx_runtime.jsxs)(LayoutContent, {
      children: [
        (0, import_jsx_runtime.jsxs)(Flex, {
          direction: "column", alignItems: "center", gap: 3, children: [
            (0, import_jsx_runtime.jsx)(Logo, {}),
            (0, import_jsx_runtime.jsx)(Typography, {
              tag: "h1", variant: "alpha", textAlign: "center", children: formatMessage({
                id: "Auth.form.welcome.title",
                defaultMessage: "Welcome to Strapi!"
              })
            }),
            (0, import_jsx_runtime.jsx)(Typography, {
              variant: "epsilon", textColor: "neutral600", textAlign: "center", children: formatMessage({
        ...
        (0, import_jsx_runtime.jsx)(
          Form2,
          {
            ...
            children: (0, import_jsx_runtime.jsxs)(Flex, {
              direction: "column", alignItems: "stretch", gap: 6, marginTop: 7, children: [
                      ...
                      label: formatMessage(
                        ...
                        },
                        {
                          terms: (0, import_jsx_runtime.jsx)(A, {
                            target: "_blank", href: "https://strapi.io/terms", rel: "noreferrer", children: formatMessage({
                              id: "Auth.privacy-policy-agreement.terms",
                              defaultMessage: "terms"
                            })
                          }),
                          policy: (0, import_jsx_runtime.jsx)(A, {
                            target: "_blank", href: "https://strapi.io/privacy", rel: "noreferrer", children: formatMessage({
                ...
                (0, import_jsx_runtime.jsx)(Button, {
                  fullWidth: true, size: "L", type: "submit", children: formatMessage({
        ...
        (match == null ? void 0 : match.params.authType) === "register" && (0, import_jsx_runtime.jsx)(Box, {
          paddingTop: 4, children: (0, import_jsx_runtime.jsx)(Flex, {
            justifyContent: "center", children: (0, import_jsx_runtime.jsx)(Link2, {
              tag: NavLink, to: "/auth/login", children: formatMessage({
              ...
              Form2,
              {
                ...
                children: (0, import_jsx_runtime.jsxs)(Flex, {
                  direction: "column", alignItems: "stretch", gap: 6, children: [
                    ...
                    (0, import_jsx_runtime.jsx)(Button, {
                      fullWidth: true, type: "submit", children: formatMessage({
...
var AuthPage = () => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-D52-chj8-CIJWNHXT.js")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-4R_fd3x_-F4S2BDVS.js")).FORMS,
    {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ChU9V3B9-XLYKBDS5.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-hAU7MYMO-2Y3JOJHF.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-CouwHHq5-GNDNVASJ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-Di3HlXje-CYQ7YDSF.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-DhzUBzXn-4PT6MNUG.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-CY7csJBb-VXGFP363.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-CxBdyVKZ-XZ72RJD3.js").then((n) => n.b);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-BIUdwz07-EPXLDXGU.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-C8TDoKgA-XFC663AF.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-DCx5JOxR-MA7B7UK3.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-BJRqDkwj-6IR5S77D.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-BaOGTZm4-FO7WQOPP.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-oxxjGoRq-NWVLQKW2.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-DViZU0kt-LS3TRJNO.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-ByaKVrZv-HYWE52KW.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-BZvdCbs2-GNT4XDVZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-DOIzr_pq-GQF6NRH7.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-BZigpAbD-Z7DW5XU7.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-CtZkFcjB-TC5SXR7S.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-D3Uf6UN4-J7WKLHQW.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-ufhuFD88-6FXMSFLK.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-DnRo5FVA-VL7KD7SN.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-CbrrMtL2-EY2FAQ2V.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-Ks5SLUGu-R4TJFUOG.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-Cg52L7aR-LGYXHM24.js");
              return {
      ...
      (0, import_jsx_runtime.jsxs)(Dialog.Footer, {
        children: [
          ...
          endAction || (0, import_jsx_runtime.jsx)(Dialog.Action, {
            children: (0, import_jsx_runtime.jsx)(Button, {
              fullWidth: true, onClick: handleConfirm, variant, loading: isConfirming, children: formatMessage({
                id: "app.components.Button.confirm",
                defaultMessage: "Confirm"
              })
            })
...
var Root$2 = ({
  ...
  return (0, import_jsx_runtime.jsx)(Popover.Root, {
    open, onOpenChange: setOpen, ...restProps, children: (0, import_jsx_runtime.jsx)(
      FiltersProvider,
      {
        setOpen,
        disabled,
...
var PopoverImpl = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Popover.Content, {
    children: (0, import_jsx_runtime.jsx)(Box, {
      padding: 3, children: (0, import_jsx_runtime.jsx)(
        Form2,
        {
          method: "POST",
          initialValues: {
          ...
          children: ({ values: formValues, modified, isSubmitting }) => {
            ...
            return (0, import_jsx_runtime.jsxs)(Flex, {
              direction: "column", alignItems: "stretch", gap: 2, style: { minWidth: 184 }, children: [
                [
                  {
                    ["aria-label"]: formatMessage({
...
var PageSize = ({ options = ["10", "20", "50", "100"] }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    gap: 2, children: [
      ...
      (0, import_jsx_runtime.jsx)(Typography, {
        textColor: "neutral600", tag: "span", children: formatMessage({
          id: "components.PageFooter.select",
          defaultMessage: "Entries per page"
        })
      })
...
var Links = ({ boundaryCount = 1, siblingCount = 1 }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Pagination, {
    activePage, pageCount, children: [
      (0, import_jsx_runtime.jsx)(PreviousLink, {
        tag: Link, to: { search: (0, import_qs.stringify)({ ...query, page: activePage - 1 }) }, children: formatMessage({
...
var SearchInput = ({
  ...
  if (isOpen) {
    return (0, import_jsx_runtime.jsx)(SearchForm, {
      onSubmit: handleSubmit, children: (0, import_jsx_runtime.jsx)(
        Searchbar,
        {
          ref: inputRef,
          name: "search",
  ...
  return (0, import_jsx_runtime.jsx)(
    Th,
    {
      ...
      children: (0, import_jsx_runtime.jsx)(TooltipImpl, {
        label: sortable ? sortLabel : label, children: (0, import_jsx_runtime.jsx)(
          Typography,
          {
...
var ActionBar = ({ children }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    gap: 2, children: [
      (0, import_jsx_runtime.jsx)(Typography, {
        variant: "omega", textColor: "neutral500", children: formatMessage(
          {
  ...
  return (0, import_jsx_runtime.jsx)(Tbody, {
    children: (0, import_jsx_runtime.jsx)(Tr, {
      children: (0, import_jsx_runtime.jsx)(Td, {
        colSpan: colCount, children: (0, import_jsx_runtime.jsx)(
          EmptyStateLayout,
          {
            content: formatMessage({
...
var CheckboxCell = ({ id, ...props }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Cell, {
    ...props, onClick: (e) => e.stopPropagation(), children: (0, import_jsx_runtime.jsx)(
      CheckboxImpl,
      {
        "aria-label": formatMessage(
          {
...
var ContentBox = ({
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    shadow: "tableShadow", hasRadius: true, padding: 6, background: "neutral0", children: [
      (0, import_jsx_runtime.jsx)(IconWrapper, { background: iconBackground, hasRadius: true, padding: 3, children: icon }),
      (0, import_jsx_runtime.jsxs)(Flex, {
        direction: "column", alignItems: "stretch", gap: endAction ? 0 : 1, children: [
          (0, import_jsx_runtime.jsxs)(Flex, {
            children: [
...
//# sourceMappingURL=chunk-OWSA2RQN.js.map
