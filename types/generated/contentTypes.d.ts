...
export interface ApiDostupnostDostupnost extends Struct.CollectionTypeSchema {
  collectionName: 'dostupnosts';
  info: {
    description: '';
    displayName: '\u0414\u043E\u0441\u0442\u0443\u043F\u043D\u043E\u0441\u0442\u044C';
    pluralName: 'dostupnosts';
    singularName: 'dostupnost';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    free: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::dostupnost.dostupnost'
    > &
      Schema.Attribute.Private;
...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    dostupnosts: Schema.Attribute.Relation<
      'oneToMany',
      'api::dostupnost.dostupnost'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dostupnost.dostupnost': ApiDostupnostDostupnost;
